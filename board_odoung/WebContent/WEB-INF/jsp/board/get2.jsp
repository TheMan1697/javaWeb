                    ...
                    <div class="card-body">
                        <form>
						  ...
						  <div class="mb-3">
							...
							<div class="row">
							<div class="col-10 bg-primary">텍스트 영역</div>
							<div class="col-2 bg-success">버튼 영역</div>
							</div>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		         <div class="mb-3 mt-3">
						    <label for="bno" class="form-label"><i class="fas fa-blind"></i> rno</label>
						    <input type="text" class="form-control" id="rno" name="rno">
						  </div>
						  <div class="mb-3">
						    <label for="title" class="form-label"><i class="fas fa-box-tissue"></i> content</label>
						    <textarea type="text" class="form-control" id="replyContent" name="replyContent"></textarea>
						  </div>
						  <div class="mb-3">
						    <label for="replyRegDate" class="form-label"><i class="fas fa-dragon"></i> regDate</label>
						    <input class="form-control" id="replyRegDate" name="replyRegDate">
						  </div>
						  <div class="mb-3">
						    <label for="writer" class="form-label"><i class="fas fa-chess-king"></i> writer</label>
...
str+='								<span class="small float-end">' +data[i].regDate+'</span></div>'
