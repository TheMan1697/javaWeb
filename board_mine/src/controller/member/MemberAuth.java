...
//		String email ="bibibik1697@gmail.com";
//		String id = "bibibik95";
		
		// 암호화 처리
		// 난수 생성
		Member member = memberService.get(id);
		member.setAuth_token(String.format("%08d", new Random().nextInt(100_000_000)));
		
		// 지정된 토큰값 처리
		//
		memberService.updateAuthToken(member);
		String host="http://servlet.silly.monster"+req.getContextPath()+"/member/ProcAuth";
		String queryString = "id="+member.getId()+"&authToken="+URLEncoder.encode(BCrypt.hashpw(member.getAuth_token(),BCrypt.gensalt()),"utf-8");
		
		String content = String.format("<table width='600' style='margin: 0 auto'>\r\n" + 
				"        <tr>\r\n" + 
				"            <td align='center'>\r\n" + 
				"                <h1 style='text-align : center'>이 이메일은 본인 확인을 위한 이메일 입니다.</h1>\r\n" + 
				"                \r\n" + 
				"            </td>\r\n" + 
				"        </tr>\r\n" + 
				"        <tr>\r\n" + 
				"            <td>\r\n" + 
				"                <p style='color : #555555;'>이 메일은 소유자가 %s님 본인일 경우 아래의 링크를 클릭하세요. </p>\r\n" + 
				"                \r\n" + 
				"            </td> \r\n" + 
				"        </tr>\r\n" + 
				"        <td>\r\n" + 
