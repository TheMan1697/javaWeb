       ...
       <div id="layoutAuthentication">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="form-floating mb-3 input-group">
                                                <input class="form-control" id="email" name="email" type="text" placeholder="enter email" value="${memberInfo.email}" readonly/>
                                                <label for="email">email</label>
                                                <c:if test="${memberInfo.auth ==0}">
                                                <button class="btn btn-danger" type="button" id="btnEmail">Email 인증</button>
                                                </c:if>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-4">
                                                    <div class=" mb-3 mb-md-0">
                                                        <input class="form-control" id="addrDetail" name="addrDetail" readonly value="${memberInfo.addrDetail}"/>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-4 mb-0">
                                                ...
                                                <div class="d-grid mt-3"><button class="btn btn-danger btn-block" formaction="secession">Remove Account</button></div>
                                            </div>
                                        </form>
                                    </div>
        ...
        $("#id").change(function(){
        	...
        	$("#btnEmail").click(function(){
        		var $btnEmail =$(this);
        		var str='<img src="http://www.loadinfo.net/main/download?spinner=103828&disposition=inline">';
        		console.log("clicked!");
        		...
        		$.ajax(cp+"/member/memberAuth",{
        			...
        			success : function(data){
        				$btnEmail.prop("disabled", false).html("Email 인증");
        				console.log(data);
        			}
        		})
        	});
